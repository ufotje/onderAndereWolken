                            ...
                            <div class="panel-heading">
                                <!--<div class="pull-left"> -->
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" class="collapseHeader fontHeader">Kijkjes</a>
                                    </h4>
                                <!--</div>-->
                            </div>
                            <div id="collapseOne" class="panel-collapse collapse in">
                                <div class="panel-body noPadding">
                                    <div class="list-group">
                                        <c:forEach items="${media}" var="movie">
                                            <c:set value="${movie.visible ? '' : 'indicateInvisible'}" var="cssVisibility"></c:set>
                                            <span id="listGroupTrips${movie.id}" class="list-group-item noPadding ${cssVisibility}">
                                                <div class="flex-parent-row">
                                                    <div class="flex-child-start">
                                                        <a href="/admin/kijkjes/wijzig_zichtbaarheid/${movie.id}" id="btnVisibilityTrips${movie.id}" class="btn btn-default paddingButtons straightBordersRight borderTopBottomTransp ${cssVisibility}"><i class="fa ${movie.visible ? 'fa-eye' : 'fa-eye-slash'} fa-fw"></i></a>
                                                    </div>
                                                    <div class="flex-child-start">
                                                        <p class="flex-center-vertical truncate-text" style="margin: 5px 0 0 5px;">${movie.title}</p>
                                                    </div>
                                                    <div class="flex-child-start btn-group" role="group">
                                                        <a href="/admin/kijkjes/bewerk/${movie.id}" class="btn btn-primary paddingButtons straightBordersLeft borderTopBottomTransp"><i class="fa fa-edit fa-fw"></i></a>
                                                        <a href="/admin/kijkjes/verwijder/${movie.id}" class="btn btn-danger paddingButtons borderTopBottomTransp"><i class="fa fa-trash-o fa-fw"></i></a>
                                                    </div>
                                                </div>
                                            </span>
                                        </c:forEach>
