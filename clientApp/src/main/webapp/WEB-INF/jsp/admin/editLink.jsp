    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div id="bewerken" class="panel panel-default">
                    <div class="panel-heading fontHeader">
                        <h4 class="panel-title">Link bewerken</h4>
                    </div>

                    <div style="padding: 2%;" class="row">
                        <div class="col-lg-12">
                            <form:form method="post" modelAttribute="addLink"
                                       action="${pageContext.request.contextPath}/admin/links/bewerk/${addLink.id}">
                                <!-- Link URL -->
                                <div class="form-group">
                                    ...
                                    <form:input path="linkUrl" cssClass="form-control"
                                                cssStyle="background-color: black; color: white;" type="text"
                                ...
                                <div class="form-group">
                                    ...
                                    <form:textarea path="description" cssClass="form-control"
                                                   cssStyle="resize: none; background-color: black; color: white;"
                                                   type="text"
...
<script>
    document.getElementById("bewerken").scrollIntoView();
