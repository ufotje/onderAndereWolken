                            ...
                            <div class="panel-heading">
                                <!--<div class="pull-left"> -->
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" class="collapseHeader fontHeader">Berichtjes</a>
                                    </h4>
                                <!--</div>-->
                            </div>
                                            ...
                                            <span id="listGroupTrips${trip.id}" class="list-group-item noPadding ${cssVisibility}">
                                                <div class="flex-parent-row">
                                                    <div class="flex-child-start">
                                                        <p class="flex-center-vertical truncate-text" style="margin: 5px 0 0 5px;">${contact.name}</p>
                                                    </div>
                                                    <div class="flex-child-start btn-group" role="group">
                                                        <a href="/admin/allecontacten/lees/${contact.id}" class="btn btn-primary paddingButtons straightBordersLeft borderTopBottomTransp"><i class="fa fa-envelope-open"></i></a>
                                                        <a href="/admin/allecontacten/verwijder/${contact.id}" class="btn btn-danger paddingButtons borderTopBottomTransp"><i class="fa fa-trash-o fa-fw"></i></a>
                                                    </div>
                                                </div>
                                            </span>
                                        </c:forEach>
